...
public class HashTableTester2 {
    ...
    private static final List<Song> songs = Arrays.asList(
            ...
            new Song("Seras-tu lˆ?", "Michel Berger", 1994),
   ...
   */
        ...
        map = new HashMap<String, Song>(numBuckets);
        for (Song song : songs) {
        ...
        if (!songTable.containsKey("Down to the Well"))
            errorLog.add("Table should contain the key 'Down to the Well', but tests show it does not");
